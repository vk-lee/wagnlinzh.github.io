...
关于nodejs和npm的内容建议参考书籍《深入浅出的nodejs》和《node.js开发指南》，这两本书中都对node.js的npm做了详细的叙述。另外现在的nodejs是自带安装npm，不需要再手动安装了（如果你在别的地方看到需要重新再安装npm的时候，你听我的。现在指：nodejs5.7.0版，LTS是4.3.1，时间2015.12.13 ）
